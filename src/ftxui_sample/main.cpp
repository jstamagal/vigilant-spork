...
// configuration step. It creates a namespace called `vigilant_spork`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", vigilant_spork::cmake::project_name, vigilant_spork::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", vigilant_spork::cmake::project_version);
      return EXIT_SUCCESS;
    }
